...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002367989146"))  # Chat id of a group for logging bot's activities/ Music Play Logs
PUBLICELOGS = int(getenv("PUBLICELOGS", "-1002423431504")) # Chat id of a group for Bot Added Messege/Leaved Messege U can Add Your Support Group id Aslo
GBANLOGS = int(getenv("GBANLOGS", "-1002357160741")) #Add Here Your Gbans Logs Channel Id 
OWNER_ID = int(getenv("OWNER_ID", "7074356361")) # Get this value from @Sophia_x_MusicBot on Telegram by /id
OWNER = int(getenv("OWNER","7074356361"))
OWNER_USERNAME = getenv("OWNER_USERNAME","Tgmaster_pro")
